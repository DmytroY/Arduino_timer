...
<img src="images/Schematic.JPG" alt="schematic" width="300">
...
<img src="images/menu.JPG" alt="main menu" width="300">
...
### Time set: 
<img src="images/time_set_h.JPG" alt="setting time" width="300">

  - Walk through parameters (day, hour, minute, second) using BACK/Next.
  - +/- modify the selected field.
### Schedule set:
<img src="images/relay_on_set.JPG" alt="set relay on" width="300">
